*** Settings ***
Documentation     Place Order: Login before Checkout
...
TC16: Place Order Login Before Checkout
    [Documentation]    Create account, logout, login, then add products and place order
    Navigate To Login / Signup Page
    ${email}=    Generate Dynamic Email    prefix=tc16_login
    ...
    Navigate To Login / Signup Page
    Login User With Credentials    ${email}    ${USER_DATA.password}
    ...
    Enter Comment And Place Order    comment=TC16 order via automation
